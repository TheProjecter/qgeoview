...
#define NULLMASK_POINT_FIX                0x80
#define NULLMASK_POINT_SATELITES          0x100
#define NULLMASK_POINT_HORIZONTALDOP      0x200
#define NULLMASK_POINT_VERTICALDOP        0x400
#define NULLMASK_POINT_POSITIONDOP        0x800
